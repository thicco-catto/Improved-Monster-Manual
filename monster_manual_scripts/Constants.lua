...
Constants.SaveKeys = {
	...
	PLAYERS_HAD_MONSTER_MANUAL = "PLAYERS_HAD_MONSTER_MANUAL",
	PERMANENT_FAMILIAR_STATS = "PERMANENT_FAMILIAR_STATS",
	NUM_PERMANENT_FAMILIARS_PER_PLAYER = "NUM_PERMANENT_FAMILIARS_PER_PLAYER"
}
